...
Messages.user_cert_missing = "ficheiro do certificado pessoal não " \
    "encontrado"
Config.instname = "UNIFEI - Universidade Federal de Itajubá"
Config.profilename = "UNIFEI - Universidade Federal de Itajubá"
Config.url = "https://unifei.edu.br/tecnologia-informacao/"
Config.email = "atendimento.ti@unifei.edu.br"
Config.title = "eduroam CAT"
Config.server_match = "palene.unifei.edu.br"
...
Config.init_confirmation = "Este instalador apenas vai funcionar " \
    "corretamente se for membro de {0} e do grupo de utilizadores: {1}."
Config.user_realm = "unifei.edu.br"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:palene.unifei.edu.br']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
-----BEGIN CERTIFICATE-----
